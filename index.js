...
const MAX_REQUEST_TIMEOUT =
  parseInt(process.env.LOGDNA_MAX_REQUEST_TIMEOUT) || 300;
const FREE_SOCKET_TIMEOUT =
...
exports.handler = (event, context, callback) => {
  ...
  console.log("NEW V DOEEE");
  console.log("RAW DATA SETART", event.awslogs.data, "END RAW DATA");
  console.log("***EVVVVVV", ev, "END EVVVV***");
